...
namespace ClassLibrary
{
    public class ShareClass
    {
        ...
        /// 获取本地应用数据路径
        /// </summary>
        public static readonly string _systemLocalAppDataPath = InitializeSystemLocalAppDataPath();
        /// <summary>
        /// 获取漫游应用数据路径
        /// </summary>
        public static readonly string _systemAppDataPath = InitializeSystemAppDataPath();
        ...
        private static string InitializeSystemLocalAppDataPath()
        {
            string localAppDataPath = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData);
            if (string.IsNullOrEmpty(localAppDataPath))
            {
                //// 回退策略，如使用临时目录或抛出更友好的异常
                //localAppDataPath = Path.GetTempPath();
                // 或者：throw new InvalidOperationException("无法获取 LocalAppData 路径");
                throw new InvalidOperationException("无法获取 LocalAppData 路径");
            }
        ...
        /// <returns></returns>
        /// <exception cref="InvalidOperationException"></exception>
        private static string InitializeSystemAppDataPath()
        {
            ...
            if (string.IsNullOrEmpty(appDataPath))
            {
                ...
                // 或者：throw new InvalidOperationException("无法获取 AppData 路径");
                throw new InvalidOperationException("无法获取 AppData 路径");
            }
            return appDataPath;
        }
        ...
        /// <summary>
        /// 数据库文件存储路径(为了解决调试与日常共用一个数据库文件)
        /// </summary>
        public static string _sqliteDataPath = AppDomain.CurrentDomain.BaseDirectory;
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
        public static string _sqliteConnectionString = $"Data Source={Path.Combine(_sqliteDataPath, _sqliteDataName)};Version=3;";
        /// <summary>
...
";
        ...
        public static bool ReadConfig()
        {
            ...
            if (!File.Exists(ClassLibrary.ShareClass._mainSettingFile))
            {
                ...
                appSettingClass.SqliteDataPath = ClassLibrary.ShareClass._sqliteDataPath;
            ...
            try
            {
                ...
                ClassLibrary.ShareClass._sqliteDataPath = appSettingClass.SqliteDataPath;

                ClassLibrary.ShareClass._sqliteConnectionString = $"Data Source={Path.Combine(_sqliteDataPath, _sqliteDataName)};Version=3;";
